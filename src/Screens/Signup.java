...
public class Signup extends javax.swing.JFrame {
    ...
    private void jSubmitBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jSubmitBtnActionPerformed
        ...
        if ((jName.getText().trim().isEmpty() == false && jAddress.getText().trim().isEmpty() == false && jCNIC.getText().trim().isEmpty() == false && jEmail.getText().trim().isEmpty() == false && String.valueOf(jPin.getPassword()).trim().isEmpty() == false && jPhoneNumber.getText().trim().isEmpty() == false && jPhoneNumber.getText().length() == 11 )) {
